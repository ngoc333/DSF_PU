...
namespace Smart_FTY
{
    public partial class FRM_PH_ANALYSIS : Form_Parent
    {
        ...
        public DataTable SEL_DATA_ANALYSIS(string Qtype, string arg_ymd, string arg_op)
        {
            COM.OraDB MyOraDB = new COM.OraDB();
            DataSet ds_ret;
            try
            {
                string process_name = "MES.PKG_SMT_B1.SP_PH_ANALYSIS_MONTH"; //SP_SMT_ANDON_DAILY

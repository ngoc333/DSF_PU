...
namespace Smart_FTY
{
    public partial class FORM_PU_MOLD_REPAIR_WEEKLY : Form
    {
        public FORM_PU_MOLD_REPAIR_WEEKLY()
        {
     ...
     //   bool _IsKey = true;
            ...
            try
            {
                ...
                switch (_frm)
                {
                    ...
                    case 3:
                        ...
                        lbl_header.Text = "PU Mold Overhaul by Week (" + DateTime.Now.AddDays(-7).ToString("MMM-dd") + " ~ " + DateTime.Now.ToString("MMM-dd") + ")";
                        viewMode = "WEEKLY";
                        axfpHeaderData.Hide();
        ...
        private DataTable LOAD_TOP15(string argMode)
        {
            ...
            try
            {
                string process_name = "MES.PKG_SMT_PU.MOLD_PU_DEFECTIVE";
                //ARGMODE
        ...
        private DataTable LOAD_MOLD_RP_W()
        {
            ...
            try
            {
                string process_name = "MES.PKG_SMT_PU.SELECT_PU_MOLD_REPAIR_W";
                //ARGMODE
        ...
        private DataTable LOAD_MOLD_RP_STYLE()
        {
            ...
            try
            {
                string process_name = "MES.PKG_SMT_PU.SELECT_PU_MOLD_REPAIR_STYLE";
                //ARGMODE
                MyOraDB.ReDim_Parameter(1);
                MyOraDB.Process_Name = process_name;
                MyOraDB.Parameter_Name[0] = "OUT_CURSOR";

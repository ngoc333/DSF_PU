...
namespace Smart_FTY
{
    public partial class FRM_SMT_PU_PROD_YEAR : Form
    {
        public FRM_SMT_PU_PROD_YEAR()
        {
            InitializeComponent();
            lblTitle.Text = "Pouring Production Status by Year";
           // formName = "FRM_SMT_PU_PROD_YEAR";
            this.Name = "FRM_SMT_PU_PROD_YEAR";
            this.Text = "FRM_SMT_PU_PROD_YEAR";
        }

        public static string _sProcess = "CMP";
        public int iCount = 0;
        string APS_YN = "N";
        private void FRM_SMT_PU_PROD_YEAR_Load(object sender, EventArgs e)
        {
        ...
        public DataTable SEL_OS_PROD_YEAR(string ARG_QTYPE, string ARG_OP)
        {
            ...
            try
            {
                string process_name = "MES.PKG_SMT_B2.SP_PU_PROD_YEAR";
        ...
        private void BindingData(string arg_op)
        {
           ...
           // dtsource = SEL_OS_PROD_YEAR("Q", arg_op);
            dtsource = SEL_OS_PROD_YEAR("Q", APS_YN, DateTime.Now.ToString("yyyy"), arg_op);
        ...
        private void bindingdatachart(string arg_op)
        {
           ...
           // dt = SEL_OS_PROD_YEAR("C", arg_op);
            dt = SEL_OS_PROD_YEAR("C", APS_YN, DateTime.Now.ToString("yyyy"), arg_op);
        ...
        private void FRM_SMT_PU_PROD_YEAR_VisibleChanged(object sender, EventArgs e)
        {

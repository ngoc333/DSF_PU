...
{
    public partial class UC_Temp_PU_MANUAL : UserControl
    {
        public UC_Temp_PU_MANUAL()
        {
            InitializeComponent();
        }
            ...
            try
            {
                ...
                switch (vitri)
                {
                    case 1:
                        ...
                        bindingchart(dt, "VAL_16", chart_4, "MATERIAL TEMPERATURE", "ISO", dt1, dt2);
                        bindingchart(dt, "VAL_17", chart_5, "OIL TEMPERATURE", "OIL", dt1, dt2);
                        bindingchart(dt, "VAL_18", chart_6, "HOSE TEMPERATURE", "ISO", dt1, dt2);
                        break;
                    case 2:
                        ...
                        bindingchart(dt, "VAL_13", chart_4, "MATERIAL TEMPERATURE", "POLY", dt1, dt2);
                        bindingchart(dt, "VAL_14", chart_5, "OIL TEMPERATURE", "OIL", dt1, dt2);
                        bindingchart(dt, "VAL_15", chart_6, "HOSE TEMPERATURE", "POLY", dt1, dt2);
                        break;
                    case 3:
                        ...
                        bindingchart(dt, "VAL_10", chart_4, "MATERIAL TEMPERATURE", "POLY", dt1, dt2);
                        bindingchart(dt, "VAL_11", chart_5, "OIL TEMPERATURE", "OIL", dt1, dt2);
                        bindingchart(dt, "VAL_12", chart_6, "HOSE TEMPERATURE", "POLY", dt1, dt2);
                        break;
                }
            }
            catch

...
namespace Smart_FTY
{
    public partial class FORM_PU_DEFFECTIVE_STATUS: Form
    {
        #region Declare
        int iNumRow = 0;
       ...
       // int _time = 0;
        ...
        #region Creation
        public FORM_PU_DEFFECTIVE_STATUS(int arg_idx = 0)
        {
            InitializeComponent();
            idx_form = arg_idx;
        }
        ...
        private DataTable select_chart_1(string arg_month)
        {
            ...
            MyOraDB.Process_Name = "MES.PKG_SMT_PU.SEL_CHART_1_V2";
        ...
        private DataTable select_deffect_monitor()
        {
            ...
            MyOraDB.Process_Name = "MES.PKG_SMT_PU.SEL_PU_DEFFECT_MONITOR";
        ...
        private DataTable select_deffect_monitor(string arg_month)
        {
            ...
            COM.OraDB MyOraDB = new COM.OraDB();
            MyOraDB.ReDim_Parameter(2);
            MyOraDB.Process_Name = "MES.PKG_SMT_PU.SEL_PU_DEFFECT_MONITOR_V2";
        ...
        private DataTable select_chart_1()
        {
            ...
            COM.OraDB MyOraDB = new COM.OraDB();
            MyOraDB.ReDim_Parameter(1);
            MyOraDB.Process_Name = "MES.PKG_SMT_PU.SEL_CHART_1";
